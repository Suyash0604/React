...
const Nav = () => {
  return (
    <div className="w-screen flex justify-center">
      <div className="w-[42%] bg-zinc-800 h-17 rounded-2xl text-white text-xl flex items-center justify-center gap-8 px-5  transition-all duration-200 ease-in font-bold">
