...
const Nav = ({ user, setUser }) => {
  ...
  return (
    <div className="w-screen flex justify-center px-2 overflow-x-hidden">
      <div className={`w-full ${user?.role === "user" ? "max-w-[700px]" : "max-w-[1200px]"} mt-5 bg-zinc-800 rounded-2xl text-white text-xl px-3 py-5 transition-all duration-200 ease-in font-bold`}>
        {/* Top bar */}
